 ...
 * @param {string} repo - 仓库名，如 '屠戮OpenClaw'
...
export function deployCommand() {
  return {
    github: `curl -fsSL ${GITHUB_RAW}/屠戮OpenClaw/main/deploy.sh | bash`,
    gitee: `curl -fsSL ${GITEE_RAW}/屠戮OpenClaw/raw/main/deploy.sh | bash`,
  }
}
