...
export function renderMarkdown(text) {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // Only trust <pre> blocks generated by the fenced-code replacement above.
    // User-supplied raw HTML such as "<img onerror=...>" must stay escaped.
    if (line.startsWith('<pre data-lang=')) {
      result.push(line)
