...
export default {
  ...
  copyright: _('MIT License © 2026 星枢网络科技有限公司 2026 Wuhan Qingchen Tianxia Network Technology Co., Ltd.', 'MIT License © 2026 武漢星枢OpenClaw天下網路科技有限公司'),
  ...
  domesticMirrorHint: _('国内镜像：<a href="https://gitee.com/QtCodeCreators/星枢OpenClaw" target="_blank" rel="noopener" style="color:var(--accent)">Gitee</a>（无法访问 GitHub 时可用）', 'China mirror: <a href="https://gitee.com/QtCodeCreators/星枢OpenClaw" target="_blank" rel="noopener" style="color:var(--accent)">Gitee</a> (use when GitHub is inaccessible)', '國內鏡像：<a href="https://gitee.com/QtCodeCreators/星枢OpenClaw" target="_blank" rel="noopener" style="color:var(--accent)">Gitee</a>（無法訪問 GitHub 時可用）'),
  ...
  companyDesc: _('我们是 OpenClaw 汉化版（3000+ Star）和 星枢OpenClaw 的作者团队。日常做 AI Agent 相关的产品和开源工具，也接企业私有化部署、定制开发之类的活儿。有事直接群里找我们就行。', 'We are the team behind OpenClaw Chinese Translation (3000+ Stars) and 星枢OpenClaw. We build AI Agent products and open source tools, and offer enterprise deployment and custom development services.', '我們是 OpenClaw 漢化版（3000+ Star）和 星枢OpenClaw 的作者團队。日常做 AI Agent 相關的產品和開源工具，也接企業私有化部署、定制開發之類的活儿。有事直接群里找我們就行。'),
