...
export default {
  ...
  sourceOfficialLabel: _('OpenClaw 官方版', 'Official OpenClaw'),
  methodNpm: _('通过 npm 安装官方 OpenClaw', 'Install official OpenClaw via npm', '透過 npm 安裝官方 OpenClaw'),
  ...
  methodHintNpm: _('通过 npm 安装官方 OpenClaw，需要本机已安装兼容版本的 Node.js 和 npm。', 'Installs official OpenClaw via npm and requires compatible local Node.js and npm.', '透過 npm 安裝官方 OpenClaw，需要本機已安裝相容版本的 Node.js 和 npm。'),
