...
export default {
  ...
  unknownLabel: _('(未知)', '(unknown)', '(未知)'),
  currentVersion: _('当前版本', 'Current Version', '目前版本'),
  recommendedVersion: _('推荐稳定版', 'Recommended Stable', '推薦穩定版'),
  panelVersion: _('面板版本', 'Panel Version', '面板版本'),
  latestUpstream: _('最新上游', 'Latest Upstream', '最新上游'),
  ...
  versionAligned: _('已对齐', 'Aligned', '已對齊'),
  versionNeedSwitch: _('需要切换', 'Needs switch', '需要切換'),
  latestAvailable: _('最新上游可用', 'Latest Upstream Available', '最新上游可用'),
  hasUpdate: _('有更新', 'Update available', '有更新'),
  ...
  viewConnectFrame: _('查看完整 Connect Frame', 'View full Connect Frame', '查看完整 Connect Frame'),
  ...
  cliUnavailable: _('OpenClaw CLI 不可用', 'OpenClaw CLI unavailable', 'OpenClaw CLI 不可用'),
  ...
  wsToken: _('Token: {token}', 'Token: {token}', 'Token: {token}'),
  ...
  wsReceivedChallenge: _('收到 challenge, nonce', 'Received challenge, nonce', '收到 challenge, nonce'),
  wsGeneratingFrame: _('生成 connect frame...', 'Generating connect frame...', '生成 connect frame...'),
  wsFrameGenerated: _('Connect frame 生成成功', 'Connect frame generated', 'Connect frame 生成成功'),
  ...
  wsHandshakeOk: _('握手成功！', 'Handshake successful!', '握手成功！', 'ハンドシェイク成功！', '핸드셰이크 성공!'),
  wsSnapshot: _('连接快照', 'Connection snapshot', '連線快照'),
  wsSessionKey: _('会话密钥: {sessionKey}', 'Session key: {sessionKey}', '對話金鑰: {sessionKey}'),
  wsClosedWithDetails: _('连接关闭 - 代码: {code}, 原因: {reason}', 'Connection closed - Code: {code}, Reason: {reason}', '連線關閉 - 代碼: {code}, 原因: {reason}'),
  wsClosedWithCode: _('连接关闭 - 代码: {code}', 'Connection closed - Code: {code}', '連線關閉 - 代碼: {code}'),
  fixTokenSecretRefNoReconnect: _('Gateway token 不是明文字符串，已刷新状态但不主动重连', 'Gateway token is not a plain string; status was refreshed but the app did not reconnect automatically', 'Gateway token 不是明文字串，已重新整理狀態但不主動重連'),
  ...
  colCommand: _('命令', 'Command', '命令', 'コマンド', '명령'),
  ...
  fixReceivedChallenge: _('收到 connect.challenge', 'Received connect.challenge', '收到 connect.challenge', 'connect.challenge を受信'),
