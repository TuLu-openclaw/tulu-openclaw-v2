...
export default {
  ...
  qtcoolSelectHint: _('从晴辰云获取到 {count} 个可用模型，勾选需要的模型后点击添加。', 'Fetched {count} available models from QingChen Cloud. Select and add.', '從星枢雲取得到 {count} 個可用模型，勾選需要的模型后点擊新增。'),
  ...
  qtcoolProviderAdded: _('已添加晴辰云（{count} 个模型）', 'Added QingChen Cloud ({count} models)', '已新增星枢雲（{count} 個模型）'),
  already: _('已有', 'Exists'),
