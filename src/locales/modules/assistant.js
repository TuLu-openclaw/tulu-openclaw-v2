...
export default {
  ...
  qtcoolName: _('晴辰云', 'QingChen Cloud', '星枢雲'),
  ...
  qtcoolSyncDesc: _('将当前晴辰云配置同步到 OpenClaw 全局配置', 'Sync current QingChen Cloud config to OpenClaw global config', '將目前星枢雲設定同步到 OpenClaw 全域設定'),
  qtcoolSyncTo: _('同步到 OpenClaw', 'Sync to OpenClaw'),
  qtcoolSyncToDesc: _('将晴辰云的 API 配置写入 OpenClaw 全局配置文件', 'Write QingChen Cloud API config to OpenClaw global config file', '將星枢雲的 API 設定写入 OpenClaw 全域設定檔案'),
  ...
  qtcoolNoProvider: _('OpenClaw 中没有找到晴辰云的配置', 'QingChen Cloud config not found in OpenClaw', 'OpenClaw 中沒有找到星枢雲的設定'),
  ...
  guideTitle: _('这是 星枢 内置的 AI 助手', 'This is 星枢\'s built-in AI assistant', '这是 星枢 內置的 AI 助手'),
