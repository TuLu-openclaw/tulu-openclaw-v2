...
export default {
  ...
  defaultName: _('屠戮助手', 'Assistant', '', 'AI アシスタント', 'AI 어시스턴트', 'Trợ lý AI', 'Asistente IA', 'Assistente IA', 'ИИ-ассистент', 'Assistant IA', 'KI-Assistent'),
  ...
  qtcoolName: _('晴辰云', 'QingChen Cloud', '屠戮雲'),
  ...
  qtcoolSyncDesc: _('将当前晴辰云配置同步到 OpenClaw 全局配置', 'Sync current QingChen Cloud config to OpenClaw global config', '將目前屠戮雲設定同步到 OpenClaw 全域設定'),
  qtcoolSyncTo: _('同步到 OpenClaw', 'Sync to OpenClaw'),
  qtcoolSyncToDesc: _('将晴辰云的 API 配置写入 OpenClaw 全局配置文件', 'Write QingChen Cloud API config to OpenClaw global config file', '將屠戮雲的 API 設定写入 OpenClaw 全域設定檔案'),
  ...
  qtcoolNoProvider: _('OpenClaw 中没有找到晴辰云的配置', 'QingChen Cloud config not found in OpenClaw', 'OpenClaw 中沒有找到屠戮雲的設定'),
  ...
  guideTitle: _('这是 屠戮OpenClaw 内置的 AI 助手', 'This is 屠戮OpenClaw\'s built-in AI assistant', '这是 屠戮OpenClaw 內置的 AI 助手'),
