...
export default {
  title: _('Agent 管理', 'Agents', 'Agent 管理', 'Agent 管理', 'Agent 관리', 'Quản lý Agent', 'Gestión de Agentes', 'Gestão de Agentes', 'Управление агентами', 'Gestion des Agents', 'Agenten-Verwaltung'),
  ...
  addAgent: _('新建专属 Agent', 'New Agent', '新建专屬 Agent', '新規 Agent', '+ 새 Agent', 'Agent mới', 'Nuevo Agent', 'Novo Agent', 'Новый агент', 'Nouvel Agent', 'Neuer Agent'),
  addEcomAgent: _('创建搬运专属 Agent', '+ Create "Automated Store Mover"', '建立搬運專屬 Agent', '「全自動店舗搬送」Agent を作成', '+ 「전자동 상품 이관」 생성', 'Tạo nhanh "搬运 cửa hàng tự động"', 'Crear "Migrador Automático de Tienda"', 'Criar "Migrador Automático de Loja"', 'Создать "Автоперенос магазина"', 'Créer « Déplacement automatique de boutique »', '„Automatischer Shop-Mover“ erstellen'),
  ...
  backup: _('备份', 'Backup', '備份', 'バックアップ', '백업', 'Sao lưu', 'Respaldo', 'Backup', 'Резервная копия', 'Sauvegarde'),
  importWorkspace: _('导入工作区', 'Import Workspace'),
  importWorkspaceTitle: _('向 Agent「{id}」导入工作区', 'Import workspace into Agent "{id}"'),
  importWorkspaceSource: _('来源 Agent', 'Source Agent'),
  importWorkspaceConfirm: _('将把 Agent「{source}」的工作区内容复制到 Agent「{target}」工作区。已有同名文件会被覆盖，确定继续？', 'Copy workspace content from Agent "{source}" into Agent "{target}". Files with the same name will be overwritten. Continue?'),
  importWorkspaceDone: _('工作区导入完成，复制 {count} 个文件', 'Workspace import complete, copied {count} files'),
  importWorkspaceFailed: _('工作区导入失败', 'Workspace import failed'),
  importWorkspaceNoSource: _('没有可导入的来源 Agent', 'No source Agent available'),
  ...
  labelModel: _('模型:', 'Model:', '模型:', 'モデル:', '모델:'),
  ...
  addTitle: _('新建 Agent', 'New Agent', '新建 Agent', '新規 Agent', '새 Agent', 'Agent mới', 'Nuevo Agent', 'Novo Agent', 'Новый агент', 'Nouvel Agent', 'Neuer Agent'),
  agentId: _('Agent ID', 'Agent ID', 'Agent ID', 'Agent ID', 'Agent ID', 'Agent ID', 'Agent ID', 'Agent ID', 'ID агента', 'ID Agent', 'Agent-ID'),
  ...
  agentNamePlaceholder: _('例如：翻译助手', 'e.g. Translation Assistant', '例如：翻譯助手', '例: 翻訳アシスタント', '예: 번역 도우미'),
  agentEmoji: _('Emoji', 'Emoji'),
  agentEmojiPlaceholder: _('例如：🌐（可选）', 'e.g. 🌐 (optional)', '例如：🌐（可選）', '例: 🌐（任意）', '예: 🌐 (선택)'),
  agentModel: _('模型', 'Model', '模型', 'モデル', '모델', 'Mô hình', 'Modelo', 'Modelo', 'Модель', 'Modèle', 'Modell'),
