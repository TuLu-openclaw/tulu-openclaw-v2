...
export default {
  ...
  addEcomAgent: _('创建电商专属Agent', '+ Create "E-commerce Dedicated Agent"', '建立電商專屬Agent', '「電商専用Agent」を作成', '+ 「전자상거래 전용 Agent」 생성', 'Tạo "Agent thương mại điện tử"', 'Crear "Agent exclusivo de e-commerce"', 'Criar "Agent exclusivo de e-commerce"', 'Создать «спецагента для e-commerce»', 'Créer « Agent dédié e-commerce »', '„E-Commerce-Spezial-Agent erstellen“'),
