...
export default {
  ...
  addAgent: _('+ 新建 Agent', '+ New Agent', '+ 新建 Agent', '+ 新規 Agent', '+ 새 Agent', '+ Agent mới', '+ Nuevo Agent', '+ Novo Agent', '+ Новый агент', '+ Nouvel Agent', '+ Neuer Agent'),
  addEcomAgent: _('+ 一键创建「全自动店铺搬运」', '+ Create "Automated Store Mover"', '+ 一鍵建立「全自動店鋪搬運」', '+ 「全自動店舗搬送」を作成', '+ 「전자동 상품 이관」 생성', '+ Tạo nhanh "搬运 cửa hàng tự động"', '+ Crear "Migrador Automático de Tienda"', '+ Criar "Migrador Automático de Loja"', '+ Создать "Автоперенос магазина"', '+ Créer « Déplacement automatique de boutique »', '+ „Automatischer Shop-Mover“ erstellen'),
