...
export default {
  ...
  semanticStatusEmoji: _('语义版状态 Emoji', 'Semantic Status Emoji', '語義版狀態 Emoji'),
  semanticStatusEmojiHint: _('为不同工作阶段分别设置 emoji；留空则由上游或默认值处理', 'Set per-phase emoji for different work stages; leave blank to use upstream/default behavior', '為不同工作階段分別設定 emoji；留空則由上游或預設值處理'),
  statusPhaseAck: _('已收到', 'Acknowledged', '已收到'),
  statusPhaseThinking: _('思考中', 'Thinking', '思考中'),
  statusPhasePlanning: _('规划中', 'Planning', '規劃中'),
  statusPhaseTool: _('调用工具', 'Using Tools', '調用工具'),
  statusPhaseWorking: _('处理中', 'Working', '處理中'),
  statusPhaseVerifying: _('校验中', 'Verifying', '校驗中'),
  statusPhaseStreaming: _('输出中', 'Streaming', '輸出中'),
  statusPhaseDone: _('已完成', 'Done', '已完成'),
  statusPhaseIdle: _('待命', 'Idle', '待命'),
