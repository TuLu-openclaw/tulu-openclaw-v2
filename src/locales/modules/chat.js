...
export default {
  ...
  guideHint: _('如需使用 屠戮OpenClaw 内置 AI 助手（独立于 OpenClaw），请前往左侧菜单「AI 助手」页面。', 'To use 屠戮OpenClaw\'s built-in AI Assistant (independent of OpenClaw), go to "AI Assistant" in the left menu.', '如需使用 屠戮OpenClaw 內置 AI 助手（獨立於 OpenClaw），請前往左側菜單「AI 助手」頁面。'),
