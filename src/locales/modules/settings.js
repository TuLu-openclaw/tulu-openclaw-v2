...
export default {
  ...
  standaloneInstallDirHint: _('用于一键安装/升级 standalone 版 OpenClaw；保存后会立即纳入自动扫描与 CLI 自动解析。', 'Used for one-click install/upgrade of the standalone OpenClaw package. Once saved, it is included in auto-scan and CLI auto-resolution immediately.', '用於一鍵安裝/升級 standalone 版 OpenClaw；儲存後會立即納入自動掃描與 CLI 自動解析。', 'Standalone 版 OpenClaw のワンクリックインストール/アップグレードに使用します。保存後すぐに自動スキャンと CLI 自動解決に含まれます。'),
