...
export default {
  ...
  signalDesc: _('接入 Signal Messenger', 'Connect to Signal Messenger', '接入 Signal Messenger', 'Signal に接続'),
  ...
  retryOrUseManualCommand: _('状态检测失败时，请点击「一键安装插件」自动修复，或复制下方手动命令到终端执行。', 'If status detection fails, click "Install Plugin" to repair automatically, or copy the manual commands below into your terminal.', '狀態檢測失敗時，請點擊「一鍵安裝外掛」自動修復，或複製下方手動命令到終端執行。'),
  keyDiagnostics: _('关键诊断项', 'Key diagnostics', '關鍵診斷項'),
  pluginPath: _('插件路径', 'Plugin path', '外掛路徑'),
  weixinStatusReady: _('微信接入已就绪', 'WeChat integration is ready', '微信接入已就緒'),
  weixinStatusPartial: _('微信插件已检测到，仍有项目需修复', 'WeChat plugin detected; some items still need repair', '已檢測到微信外掛，仍有項目需修復'),
  ...
  pairingCodePlaceholder: _('例如 R3ZFPWZP', 'e.g. R3ZFPWZP', '例如 R3ZFPWZP', 'ペアリングコードを入力'),
  ...
  qqDiagHint: _('检查<strong>已保存到配置文件</strong>的凭证、本机 Gateway 端口、<code>/__api/health</code>、QQ 插件与 chatCompletions。QQ 提示「灵魂不在线」时优先看此处，并参考 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">OpenClaw × QQ 常见问题</a>。', 'Checks credentials <strong>saved to the config file</strong>, the local Gateway port, <code>/__api/health</code>, the QQ plugin, and chatCompletions. If QQ says "soul offline", start here and compare with the <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">OpenClaw × QQ FAQ</a>.', '檢查<strong>已儲存到設定檔案</strong>的憑證、本機 Gateway 連接埠、<code>/__api/health</code>、QQ 外掛與 chatCompletions。QQ 提示「靈魂不線上」時優先看此處，並參考 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">OpenClaw × QQ 常见問題</a>。'),
  ...
  qqVerifyNote: _('此项只验证 AppID/Secret 能否向腾讯换 token。<strong>不能</strong>代表 QQ 里机器人已在线；若提示「灵魂不在线」，请使用下方 <strong>完整联通诊断</strong> 并对照 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">QQ OpenClaw 常见问题</a>。', 'This only verifies whether AppID/Secret can exchange a token with Tencent. It <strong>does not</strong> mean the bot is online in QQ. If QQ says "soul offline", use the <strong>Full Connectivity Diagnosis</strong> below and compare with the <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">QQ OpenClaw FAQ</a>.', '此項只驗證 AppID/Secret 能否向腾訊換 token。<strong>不能</strong>代表 QQ 里機器人已線上；若提示「靈魂不線上」，請使用下方 <strong>完整聯通诊斷</strong> 並对照 <a href="https://q.qq.com/qqbot/openclaw/faq.html" target="_blank" rel="noopener">QQ OpenClaw 常见問題</a>。'),
