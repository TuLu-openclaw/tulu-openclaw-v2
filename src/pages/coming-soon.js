...
function render() {
  ...
  const iframeWrap = '<div class="coming-soon-container">' +
    ...
    '    </div>' +
    '  </div>'
  const footer = '<div class="coming-soon-footer">' +
  ...
  const iframe = el.querySelector('#coming-soon-iframe')
  const fallback = el.querySelector('#coming-soon-fallback')
