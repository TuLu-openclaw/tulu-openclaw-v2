    ...
    <div class="setup-shell">
      <div class="setup-hero">
        <div class="setup-hero-brand">
          <img src="/images/logo-brand.png" alt="星枢OpenClaw" class="setup-hero-logo">
        ...
        <div class="setup-help-content">
          ...
          ${isWin ? `
            <div class="setup-help-block">
              ...
              <code class="setup-help-code">curl -fsSL https://raw.githubusercontent.com/qingchencloud/星枢OpenClaw/main/deploy.sh | bash</code>
