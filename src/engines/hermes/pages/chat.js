...
const COLLAB_TASK_PRESETS = [
  {
    key: 'code-fix',
    nameKey: 'engine.collabPresetCodeFix',
    leadEngine: 'Hermes',
    supportEngine: 'OpenClaw',
    leadTaskKey: 'engine.collabPresetCodeFixLeadTask',
    supportTaskKey: 'engine.collabPresetCodeFixSupportTask',
    autoIterate: true,
    maxRounds: 3,
  },
  {
    key: 'ui-regression',
    nameKey: 'engine.collabPresetUiRegression',
    leadEngine: 'Hermes',
    supportEngine: 'OpenClaw',
    leadTaskKey: 'engine.collabPresetUiRegressionLeadTask',
    supportTaskKey: 'engine.collabPresetUiRegressionSupportTask',
    autoIterate: true,
    maxRounds: 3,
  },
  {
    key: 'diagnosis',
    nameKey: 'engine.collabPresetDiagnosis',
    leadEngine: 'OpenClaw',
    supportEngine: 'Hermes',
    leadTaskKey: 'engine.collabPresetDiagnosisLeadTask',
    supportTaskKey: 'engine.collabPresetDiagnosisSupportTask',
    autoIterate: true,
    maxRounds: 3,
  },
  {
    key: 'doc-plan',
    nameKey: 'engine.collabPresetDocPlan',
    leadEngine: 'Hermes',
    supportEngine: 'OpenClaw',
    leadTaskKey: 'engine.collabPresetDocPlanLeadTask',
    supportTaskKey: 'engine.collabPresetDocPlanSupportTask',
    autoIterate: false,
    maxRounds: 2,
  },
]
...
export function render() {
  ...
  function renderCollabPicker() {
    ...
    const presetCards = COLLAB_TASK_PRESETS.map(preset => `
      <button type="button" class="hm-collab-picker-preset" data-collab-preset="${escAttr(preset.key)}">
        <span class="hm-collab-picker-preset-title">${escHtml(t(preset.nameKey))}</span>
  ...
  function applyCollabPreset(presetKey) {
    ...
    collabLeadTask = t(preset.leadTaskKey)
    collabSupportTask = t(preset.supportTaskKey)
