...
export function getNavItems() {
    ...
    return [{
      ...
      items: [
        { route: '/h/profiles', label: t('sidebar.profiles'), icon: 'users' },
        { route: '/h/gateways', label: t('sidebar.gateways'), icon: 'gateway' },
        { route: '/h/oauth', label: t('sidebar.oauth'), icon: 'key' },
        { route: '/h/lazy-deps', label: t('sidebar.lazyDeps'), icon: 'package' },
        { route: '/h/kanban', label: t('sidebar.kanban'), icon: 'clipboard' },
        { route: '/h/files', label: t('sidebar.files'), icon: 'file-text' },
